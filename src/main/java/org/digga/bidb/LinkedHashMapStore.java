...
public class LinkedHashMapStore extends InMemoryStore {

    private static Logger log = LoggerFactory.getLogger(LinkedHashMapStore.class);

    private ReentrantLock lock = new ReentrantLock();
    private Map<Long, BiDocument> documentCache; // docId = Document

    public LinkedHashMapStore(Database database, String storeName, boolean readonly) {
    ...
    public void open() throws IOException {
        ...
        try {
            ...
            documentCache = new LinkedHashMap();
    ...
    public int forEach(Consumer<BiDocument> action) {
        int docCount = 0;
        for (Map.Entry<Long, BiDocument> entry : documentCache.entrySet()) {
